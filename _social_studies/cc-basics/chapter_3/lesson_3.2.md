...
Important Supreme Court cases were decided during this time. In a series of decisions, the Court ruled that the Bill of Rights applied to states as well as to the federal government. Specifically, the Supreme Court made these rulings:
  ...
  * {: .collection-item } Evidence illegally collected is inadmissible, or not allowed, in court.
  * {: .collection-item } All suspects have a right to a lawyer during police questioning and at trial.
  * {: .collection-item } Police must inform people of their rights when they are arrested (the Miranda warning).
  {: .collection }
...
![Martin Luther King Jr. Memorial](-mlk_memorial.jpg){: .responsive-img .materialboxed }
...
During and after World War II, more women joined the workforce. But only certain jobs were offered to women, and their pay was not equal to the pay men received. Using their experience with civil rights, women began to protest. As a result, these legislative reforms were enacted:
  ...
  * {: .collection-item } 1963: Equal Pay Act makes it illegal to pay men more than women for the same job  
  * {: .collection-item } 1964: Civil Rights Act, Title VII, outlaws job discrimination on the basis of race, color, religion, national origin, and gender  
  * {: .collection-item } 1972: Educational Amendments, Title IX, makes it illegal for any school receiving federal funds to discriminate on the basis of gender
  {: .collection }